...
&\\
{\color{bluesol}\fontsize{50}{50}\selectfont Vol. I, No. 4}&\\
&\\
\rowcolor{csccccccc}
Nada é impossível: Sérgio Miguel Cabila & {\fontsize{50}{50}\selectfont 1}\\
\rowcolor{cscccccc}
Solução em ação:  João Afonso Gaspar &  {\fontsize{50}{50}\selectfont 3}\\
\rowcolor{csccccc}
Matemática em engenharia: Acção dos agentes $\;$ & \\ \rowcolor{csccccc}
atmosféricos sobre as  $\;$linhas aéreas & {\fontsize{50}{50}\selectfont 6}\\
\rowcolor{cscccc}
Informática en ingeniería: Polinomios, parte II & {\fontsize{50}{50}\selectfont 13}\\
\rowcolor{csccc}
Novedades:  Sistema prepago en Ángola &{\fontsize{50}{50}\selectfont 21}\\
\rowcolor{cscc}
Pensar jugando&  {\fontsize{50}{50}\selectfont 24}\\
\end{tabularx}}}
\end{document}
%%% Local Variables: 
%%% mode: latex
